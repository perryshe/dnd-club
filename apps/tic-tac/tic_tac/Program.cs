...
Console.WriteLine("  POST /api/game            - Create new game [Auth]");
Console.WriteLine("  GET  /api/game/available  - List joinable games [Auth]");
Console.WriteLine("  POST /api/game/{id}/join  - Join a game [Auth]");
Console.WriteLine("  GET  /api/game/{id}       - Get game state [Auth]");
