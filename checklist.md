...
| # | Задача | Зачем | Готовность |
|---|---|---|---|
| 0.1 | `git pull origin develop` | Актуальный код перед стартом | ⬜ |
...
**Зависимости:** Phase 1 (env), Phase 2 (CSP)
...
**Зависимости:** Phase 4 (чтобы не делать две реорганизации сразу)
...
**Зависимости:** лучше после Phase 4 (чтобы не менять дважды)
...
| # | Задача | Зачем | Файлы | Готовность |
|---|---|---|---|---|
| 41 | Zero-downtime deploy | Убрать maintenance window | `maintenance.sh`, `deploy-v2.yml` | ⬜ |
| 42 | Staging-окружение | Тестировать перед продом | Новый compose-файл или VPS | ⬜ |
| 43 | Мониторинг и алерты | Не пропускать инциденты | — | ⬜ |

---

**Итого:** 44 пункта, 11 фаз.
