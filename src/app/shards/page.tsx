...
export default async function ShardsPage() {
  ...
  return (
    <div className="min-h-screen text-white scanlines">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <h1 className="text-4xl font-black">
              <span className="bg-gradient-to-r from-cyan-300 via-purple-400 to-pink-400 bg-clip-text text-transparent glitch">
